...
import nbformat
import os
from khulnasoft_jupyter.lsp import LSPWrapper
...
def setup_handlers(server_app):
    ...
    host_pattern = ".*$"
    base_url = web_app.settings["base_url"] + "khulnasoft-jupyter"
    handlers = [
    ...
    for handler in handlers:
        logging.info("khulnasoft_jupyter | Registered handler at %s", handler[0])

    logging.info("khulnasoft_jupyter | Sucessfully registered handlers at %s", base_url)
